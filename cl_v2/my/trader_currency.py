...
class CurrencyTrader(trader.Trader):
    ...
    def __init__(self, name, is_stock=True, is_futures=False, mmds=None, log=None, is_save_kline=True):
        super().__init__(name, is_stock, is_futures, mmds, log, is_save_kline)
