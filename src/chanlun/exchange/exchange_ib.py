...
class ExchangeIB(Exchange):
    ...
    @retry(stop=stop_after_attempt(2), wait=wait_random(min=1, max=5), retry=retry_if_result(lambda _r: _r is None))
    def klines(
        ...
        # 控制获取的数量
        duration_map = {
            'w': '20 Y', 'd': '5 Y', '60m': '180 D', '30m': '100 D',
            '10m': '30 D', '15m': '30 D', '5m': '15 D', '2m': '6 D', '1m': '3 D'
        }
