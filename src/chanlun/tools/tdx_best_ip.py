...
stock_ip = [
    ...
    # {"ip": "124.71.187.72", "port": 7709, "name": "通达信上海双线主站13"},  # 调用报错
    ...
    # {"ip": "150.158.160.2", "port": 7709},
    # {"ip": "62.234.50.143", "port": 7709},
    # {"ip": "81.70.151.186", "port": 7709},
    # {"ip": "82.156.214.79", "port": 7709},
    # {"ip": "159.75.29.111", "port": 7709},
    # {"ip": "43.139.18.171", "port": 7709},
    # {"ip": "81.71.32.47", "port": 7709},
    # {"ip": "101.42.240.54", "port": 7709},
    # {"ip": "101.43.159.194", "port": 7709},
    # {"ip": "120.53.8.251", "port": 7709},
    # {"ip": "152.136.191.169", "port": 7709},
    # {"ip": "49.232.15.141", "port": 7709},
    # {"ip": "82.156.174.84", "port": 7709},
    # {"ip": "101.42.164.241", "port": 7709},
    # {"ip": "101.35.121.35", "port": 7709},
    # {"ip": "111.231.113.208", "port": 7709},
]
    ...
    for ip in stock_ip:
        try:
            ...
            with client.connect(ip["ip"], ip["port"]):
                klines = client.get_security_bars(9, 1, "600519", 0, 100)
